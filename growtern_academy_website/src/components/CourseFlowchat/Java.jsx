...
import SpringBoot from "../../assets/Logos/Spring_boot.png";
import Mysql from "../../assets/Logos/SQLlogo.png"
    ...
    <div className="hero-section">
      <style>{`
        ...
        .react { background: #61dafb; color: #000; }
         .java { background: #f4bc42ff; }
        .Springboot { background: #68a063;; }
        .mysql { background: #076d3f; border-radius: 50%; }
  ...
  .hero-section {
    padding: 0px;
      ...
      <div className="tech-flow">
        ...
        <div className="tech-icon Springboot">
          <div className="icon-text">
            <img src={SpringBoot} alt="Java" />
          </div>
          <div className="icon-label">Spring Boot</div>
        </div>
        ...
        <div className="tech-icon mysql">
          ...
          <div className="icon-label">MY SQL</div>
        </div>
      </div>
    </div>
  );
