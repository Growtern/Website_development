      ...
      `}</style>
            ...
            <div className="tech-flow">
                ...
                <div className="tech-icon css">
                    <div className="icon-text">🔢</div>
                    <div className="icon-label">NumPy</div>
                </div>

                <div className="tech-icon bootstrap">
                    <div className="icon-text">🐼</div>
                    <div className="icon-label">Pandas</div>
                </div>

                <div className="tech-icon js">
                    <div className="icon-text">📊</div>
                    <div className="icon-label">Matplotlib</div>
                </div>
                ...
                <div className="tech-icon ml">
                    <div className="icon-text">🧠</div>
                    <div className="icon-label">ML</div>
                </div>

                <div className="tech-icon next">
                    <div className="icon-text">🤖</div>
                    <div className="icon-label">DL</div>
                </div>

                <div className="tech-icon Tailwind">
                    <div className="icon-text">🚀</div>
                    <div className="icon-label">AI Projects</div>
                </div>
            </div>
        </div>
    );
