    ...
    <div className="hero-section">
      <style>{`
        ...
        .react { background: #61dafb; color: #000; }
         .Python { background: #e67cf6ff; }
        .django { background: #68a063;; }
    ...
    padding: 0px;
      ...
      <div className="tech-flow">
        ...
        <div className="tech-icon django">
         <div className="icon-text">dj</div>
          <div className="icon-label">Django</div>
        </div>
